...
class RFStockTrainer:
    ...
    def fit(self) -> None:
        ...
        # --- training module ---
        RFRegressor = RandomForestRegressor(n_estimators=int(self.hparams.method.split('_')[1]))
        ...
        with self.profiler.profile('Fit Model'):
            RFRegressor.fit(train_data, train_noise)
        ...
        with self.profiler.profile('Validation Loop (Train)'):
            ...
            pred_noise = RFRegressor.predict(train_data)
